...
import com.v1.cvealert.repository.ISubsProductRepository;
...
public class SubsProductService implements ISubsProductService{
    ...
    @Override
    public Optional<SubsProductDO> getSubsByProductID(Long productID) {
        return subsRepository.findByProductID(productID);
    }
}
